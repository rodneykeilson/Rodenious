...
async function buildAboutScreen(app: SekaiUIApp, navigate: (s: Screen) => void) {
  ...
  const lines = [
    { text: "Hi! I'm Vewaxio,", style: 'name' },
...
async function buildContactScreen(app: SekaiUIApp, navigate: (s: Screen) => void) {
  ...
  const contacts = [
    { text: 'メール', sub: 'EMAIL', url: 'mailto:49758078+vewaxio@users.noreply.github.com', color: SEKAI_COLORS.sekai_cyan },
    { text: 'GitHub', sub: 'GITHUB', url: 'https://github.com/vewaxio', color: SEKAI_COLORS.sekai_purple },
    { text: 'LinkedIn', sub: 'LINKEDIN', url: 'https://linkedin.com/in/vewaxio', color: SEKAI_COLORS.leoneed },
  ];
