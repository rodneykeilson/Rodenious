    ...
    <div className="min-h-screen font-sans selection:bg-[#ff4f9a] selection:text-white pb-8">
      ...
      <section id="contact" className="py-32 px-6 bg-[#000000] text-center border-t border-gray-900 border-b border-b-gray-900">
        <div className="max-w-2xl mx-auto flex flex-col items-center">
          ...
          <a href="mailto:49758078+vewaxio@users.noreply.github.com" className="inline-block border border-[#ff4f9a] text-[#ff4f9a] hover:bg-[#ff4f9a]/10 px-8 py-4 rounded-md transition-colors font-medium tracking-wide">
            Say Hello
          </a>
        </div>
      </section>
      ...
      <footer className="py-8 bg-[#0b0b0f] text-center">
        <p className="text-[#a1a1aa] font-mono text-sm group">
          <a href="https://github.com/vewaxio" target="_blank" rel="noopener noreferrer" className="hover:text-[#ff4f9a] transition-colors">
            Designed & Built by Vewaxio
          </a>
        </p>
      </footer>
    </div>
