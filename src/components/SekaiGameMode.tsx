...
function ContactScreen({ navigate }: { navigate: (s: Screen) => void }) {
  const contacts = [
    { jp: 'メール', en: 'EMAIL', icon: Mail, url: 'mailto:49758078+vewaxio@users.noreply.github.com', color: '#00CCC0' },
    { jp: 'GitHub', en: 'GITHUB', icon: Github, url: 'https://github.com/vewaxio', color: '#BB88FF' },
    { jp: 'LinkedIn', en: 'LINKEDIN', icon: Linkedin, url: 'https://linkedin.com/in/vewaxio', color: '#4499EE' },
  ];
