  ...
  return (
    ...
    >
      ...
      <div className="px-4 py-6 max-w-4xl mx-auto">
        ...
        >
          <a
            href="https://github.com/vewaxio?tab=repositories"
            target="_blank"
            rel="noopener noreferrer"
...
function AboutScreen({ navigate }: { navigate: (s: Screen) => void }) {
  const lines = [
    { text: "Hi! I'm Vewaxio,", highlight: true },
    { text: "also known as Vewaxio.", jp: true },
    { text: "" },
...
function ContactScreen({ navigate }: { navigate: (s: Screen) => void }) {
  const contacts = [
    { label: 'Email', en: 'EMAIL', icon: Mail, url: 'mailto:49758078+vewaxio@users.noreply.github.com', color: '#00CCC0' },
    { label: 'GitHub', en: 'GITHUB', icon: Github, url: 'https://github.com/vewaxio', color: '#BB88FF' },
    { label: 'LinkedIn', en: 'LINKEDIN', icon: Linkedin, url: 'https://linkedin.com/in/vewaxio', color: '#4499EE' },
  ];
