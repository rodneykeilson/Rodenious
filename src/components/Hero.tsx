      ...
      >
        ...
        >
          <span className="relative inline-block">
            <span className="text-gradient relative z-10">Vewaxio</span>
        ...
        >
          ...
          >
            <span className="relative z-10 text-sekai-pink font-bold">Vewaxio</span>
            <motion.span
        ...
        >
          {[
            { icon: Github, href: 'https://github.com/vewaxio', color: 'cyan', label: 'GitHub' },
            { icon: Mail, href: 'mailto:49758078+vewaxio@users.noreply.github.com', color: 'pink', label: 'Email' },
            { icon: Linkedin, href: 'https://linkedin.com/in/vewaxio', color: 'purple', label: 'LinkedIn' },
