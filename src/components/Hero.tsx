  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <SekaiSocialLink icon={Github} href="https://github.com/vewaxio" label="GitHub" />
          <SekaiSocialLink icon={Mail} href="mailto:49758078+vewaxio@users.noreply.github.com" label="Email" />
          <SekaiSocialLink icon={Linkedin} href="https://linkedin.com/in/vewaxio" label="LinkedIn" />
        </motion.div>
      </motion.div>
