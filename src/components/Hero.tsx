  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="text-gradient text-glow-cyan">Vewaxio</span>
        </motion.h1>
        ...
        >
          {[
            { icon: Github, href: 'https://github.com/vewaxio', label: 'GitHub' },
            { icon: Mail, href: 'mailto:49758078+vewaxio@users.noreply.github.com', label: 'Email' },
            { icon: Linkedin, href: 'https://linkedin.com/in/vewaxio', label: 'LinkedIn' },
